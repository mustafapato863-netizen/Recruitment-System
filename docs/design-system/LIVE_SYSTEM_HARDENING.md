...
Status: `DS-LIVE-02` in progress
Product boundary: Light + Dark; Light is the first-visit default

The 2026-08-18 dual-mode approval supersedes historical light-only statements below and in earlier V1 audit evidence. Both modes now share the same semantic component, accessibility, responsive, and runtime-truth gates.
...
- `apps/web/src/styles/tokens.css` — semantic Light/Dark tokens and one-release compatibility aliases.
...
- Light and Dark use the same semantic roles, component states, and acceptance scenarios; Light remains the first-visit default.
...
- No new dependency, product route, API claim, credential, or additional theme behavior without an approved contract.
