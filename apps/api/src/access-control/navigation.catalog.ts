 ...
 */
// Keep the API catalogue local at runtime. The shared contracts package is
// type-only for the API, so the compiled service does not depend on workspace
// TypeScript sources being present in the production image.
