    ...
    >
      ...
      <Tabs
        ...
        items={[
          ...
          { key: 'hires', label: `Hires (${joinedApplications.length})` },
        ]}
      ...
      {activeTab === 'hires' && (
        <section className="rf-table-shell overflow-hidden rounded-2xl border border-rf-border-subtle bg-white shadow-xs">
          <div className="p-4 border-b border-rf-border-subtle bg-rf-surface-subtle flex items-center justify-between">
            <div>
              <h3 className="text-xs font-bold text-rf-ink m-0">Confirmed Hires ({joinedApplications.length})</h3>
              <p className="text-[11px] text-rf-ink-muted font-medium m-0 mt-0.5">Candidates who have accepted and completed the hiring gate.</p>
            </div>
            <Button variant="secondary" size="sm" asChild>
