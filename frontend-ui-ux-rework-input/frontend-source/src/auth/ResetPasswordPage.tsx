...
export function ResetPasswordPage() {
  ...
  const validate = () => {
    ...
    if (newPassword.length < 8) errors.password = 'Password must be at least 8 characters.';
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await postApi('/auth/password-reset/complete', { token, newPassword });
      setStatus('success');
    } catch (err: unknown) {
      setStatus('error');
          ...
          <div className="p-8 sm:p-10">
            ...
            {status === 'invalid-token' ? (
              <div className="text-center">
                ...
                <Link to="/forgot-password" className="text-[13px] font-semibold text-rf-action hover:underline">
                  Request new reset link
                </Link>
              </div>
            ) : status === 'success' ? (
              <div className="text-center">
                <Alert tone="success" title="Password Updated" className="mb-6 text-left">
              ...
              <form onSubmit={handleSubmit} noValidate className="grid gap-5">
                ...
                <FormField error={fieldErrors.password} id="new-password" label="New Password" required>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      aria-describedby={fieldErrors.password ? 'new-password-message' : undefined}
                    />
                    <button
                      type="button"
